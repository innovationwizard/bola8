...
/** Per-call context for usage logging. Callers pass post_id/project_id/etc.; this
 * file fills in provider/model/operation automatically. */
...
export async function createImageWithGoogle(
  ...
  return withUsageLogging(
    { ...ctx, provider: 'google', model: CREATION_MODEL, operation: 'create' },
    async () => {
      const ai = getClient();
...
export async function composeImageWithGoogle(
  ...
  return withUsageLogging(
    { ...ctx, provider: 'google', model: COMPOSITION_MODEL, operation: 'compose' },
    async () => {
      const ai = getClient();
...
export async function applyStyleReferences(
  ...
  return withUsageLogging(
    { ...ctx, provider: 'google', model: COMPOSITION_MODEL, operation: 'style' },
    async () => {
      const ai = getClient();
...
export async function generateFromRender(
  ...
  return withUsageLogging(
    { ...ctx, provider: 'google', model: COMPOSITION_MODEL, operation: 'render' },
    async () => {
      const ai = getClient();
...
export async function extractBrandFromDocuments(
  ...
  return withUsageLogging(
    { ...ctx, provider: 'google', model: EXTRACTION_MODEL, operation: 'extract' },
    async () => {
      const ai = getClient();
